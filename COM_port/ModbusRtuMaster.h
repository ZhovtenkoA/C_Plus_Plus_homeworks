...
public:
  ...
  //  bool readHoldingRegisters(quint8 slaveAddress, quint16 startAddress, quint16 count);
  //  bool readInputRegisters(quint8 slaveAddress, quint16 startAddress, quint16 count);
  //  bool readCoils(quint8 slaveAddress, quint16 startAddress, quint16 count);
  //  bool readDiscreteInputs(quint8 slaveAddress, quint16 startAddress, quint16 count);
